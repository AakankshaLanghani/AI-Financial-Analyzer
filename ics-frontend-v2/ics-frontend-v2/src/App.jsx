...
export default function App() {
  ...
  // Show login screen if not authenticated — placed after all hooks
  if (!token) {
    return <LoginPage onLogin={handleLogin} backendUrl={BACKEND} />;
  }
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <button
            ...
            onMouseOver={e => { e.currentTarget.style.borderColor = '#C31D27'; e.currentTarget.style.color = '#C31D27'; }}
            onMouseOut={e => { e.currentTarget.style.borderColor = '#e2e5ea'; e.currentTarget.style.color = '#6b7280'; }}
          >
